const languageData = {
  ...
  PT: {
    ...
    whoTitle: "Кто мы:",
    whoP1: "GADH представляет собой <span>глобальную коллективную инициативу</span>, объединяющую правозащитные организации, общественные сети и коалиции, а также технических партнеров. Вместе мы стремимся обеспечить подотчетную, доступную и приемлемую медицинскую помощь для всех людей, живущих с ВИЧ, туберкулезом и малярией, а также для тех, кто подвержен риску заражения этими заболеваниями.",
