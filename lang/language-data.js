const languageData = {
  ...
  PT: {
    ...
    heroDescription: "Сообщества, наиболее пострадавшие от ВИЧ, туберкулеза и малярии, находятся в центре модели Глобального фонда. Эта платформа предоставляет информацию, ресурсы и данные, необходимые сообществам для адвокации подотчетности Глобального фонда.",
    ...
    feedbackTitle: "Поделитесь своими отзывами",
    feedbackP1: "Эта форма предназначена для регистрации вопросов, проблем или проблем, связанных с замедлением или перераспределением средств Глобального фонда. Это независимая инициатива, управляемая сообществом, призванная документировать и решать проблемы исключения или дискриминации сообществ.",
    feedbackP2: "Все, что вы сообщаете, является анонимным, и мы никогда не будем делиться ничем без вашего согласия и согласия. Если вы решите эскалировать проблему из вашей страны, мы можем помочь связаться с нужными людьми в Глобальном фонде, связать вас с другими людьми, имеющими ту же проблему, и/или выступать от вашего имени. Наша цель - поддержать вас.",
    ...
    feedbackP1: "Fomu hii ni kwa ajili ya kusajili maswali, changamoto, au masuala na mchakato wa kupunguza kasi wa Global Fund au wa ugawaji. Huu ni mpango huru unaoendeshwa na jamii unaokusudiwa kuweka kumbukumbu na kutatua masuala ya kutengwa au ubaguzi wa jamii.", 
    feedbackP2: "Kila kitu unachoripoti hakitatambuliwa na hatutawahi kushiriki chochote bila makubaliano na idhini yako. Ikiwa unachagua kuendeleza suala kutoka katika nchi yako, tunaweza kusaidia kuwasiliana na watu wanaofaa katika Global Fund, kukuunganisha na watu wengine walio na suala kama hilo, na/au kutetea kwa niaba yako. Lengo letu ni kukuunga mkono.",
